...
///
/// Takes a loaded [AudioData] and processes its raw samples in chunks
/// to detect beats and intensity changes using an [AudioProcessor].
public class AudioAnalyzer {
    ...
    /// sequentially into the [AudioProcessor]. Once the entire track is processed,
    /// the collected events are sorted chronologically by their timestamp.
    ///
    /// @return A chronologically sorted list of detected [BeatEvent]s.
