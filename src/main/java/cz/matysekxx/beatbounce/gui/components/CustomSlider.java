...
public class CustomSlider extends JSlider {
    ...
    private class CustomSliderUI extends BasicSliderUI {
        ...
        public void paintTrack(Graphics g) {
            ...
            final int ty = trackRect.y + trackRect.height / 2 - trackH / 2;

            g2.setColor(new Color(40, 40, 45));
            g2.fillRoundRect(trackRect.x, ty, trackRect.width, trackH, trackH, trackH);
            g2.setColor(RenderUtils.cyan);
            final int fillWidth = thumbRect.x + thumbRect.width / 2 - trackRect.x;
            if (fillWidth > 0) {
                g2.fillRoundRect(trackRect.x, ty, fillWidth, trackH, trackH, trackH);
            }
            g2.dispose();
        }
        ...
        public void paintThumb(Graphics g) {
            ...
            g2.setColor(RenderUtils.cyan);
            g2.fillOval(thumbRect.x, thumbRect.y + thumbRect.height / 2 - thumbSize / 2, thumbSize, thumbSize);
            g2.setColor(Color.WHITE);
            g2.fillOval(thumbRect.x + (thumbSize - innerSize) / 2, thumbRect.y + thumbRect.height / 2 - innerSize / 2, innerSize, innerSize);
            g2.dispose();
        }
